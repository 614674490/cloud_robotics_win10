...
from FaceNet_four_action_simulator.four_action_simulator_v1_fnet import \
    FourActionOffloadEnv

from rl_trainer.agents.models import A2C, PPO
from rl_trainer.train import AsyncTrainer, Evaluator, Trainer
from rl_trainer.utils import (GlobalCounter, init_model_summary, init_out_dir,
                              signal_handler)
...
def train(parser, train_seeds, test_seeds, algo, env_name, base_dir):
    ...
    if num_env == 1:
        ...
        trainer = Trainer(env, global_model, save_path, summary_writer,
                          global_counter, model_summary, train_seeds=train_seeds)
    ...
    if save_flag.lower().startswith('y'):
        ...
        global_model.save(saver, save_path + 'checkpoint',
                          global_counter.cur_step)
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        train(parser, train_seeds, test_seeds,
              args.agent, args.env_name, args.base_dir)
